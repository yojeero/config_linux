...
# Or manually 
sudo nano /etc/portage/repos.conf/quilat-overlay.conf:
...
# Or manually 
sudo nano /etc/portage/repos.conf/tdgentoo.conf:
...
# Or manually 
sudo nano /etc/portage/repos.conf/dacyberduck.conf
