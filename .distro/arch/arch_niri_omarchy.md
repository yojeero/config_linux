...
sudo pacman -Sy glibc wayland wayland-protocols libinput libdrm libxkbcommon pixman git meson ninja libdisplay-info libliftoff hwdata seatd pcre2 kitty fuzzel swaybg firefox ttf-jetbrains-mono-nerd xwayland-sattelite
